        ...
        <v-row>
          <v-col md="4">
            ...
            <div class="mt-8" style="display:flex; align-items: center; flex-direction: column;">
                <img src="https://pbs.twimg.com/profile_images/1560094845712343040/qkEGchlH_400x400.jpg" style="border-radius: 80px; margin-bottom: 16px; object-fit: cover;" width="160" height="160" />
                <div style="display: flex; align-items: center; column-gap: 8px; font-size: 20px;"><p>Manas Malla</p>
                    <p style="padding: 6px 12px;font-size: 12px; border-radius: 6px; color: white; border: 1px #202023 solid; background-color: #ea4335; width: fit-content;">Organizer</p>
                    </div>
          ...
          <v-col md="8">
            <v-card class="pa-3">
                <v-row>
                  <v-col v-for="(item, index) in badges" cols="3" style="display: flex; flex-direction: column; align-items: center; justify-items: center">
